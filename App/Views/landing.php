...
|--------------------------------------------------------------------------
| Główna strona serwisu z wyszukiwarką pojazdów i kluczowymi cechami.
|
| Ścieżka: public/views/landing.php
|
| Technologie:
| - PHP 8+ (backend)
| - HTML, CSS (interfejs)
...
require_once __DIR__ . '/../layouts/header.php'; // Load the header
?>
