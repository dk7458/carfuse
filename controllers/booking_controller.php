...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_POST['action'] === 'create_booking') {
        ...
        sendEmail($customer['email'], "Booking Confirmation", $emailContent);
    ...
    // Restrict actions to user's bookings
    if ($_SERVER['REQUEST_METHOD'] === 'GET' && $_GET['action'] === 'fetch_bookings') {
