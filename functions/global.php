...
/**
 * File Path: /functions/global.php
 * Purpose: Contains globally applicable utility functions for the Carfuse application, such as role-based access control, CSRF token handling, and general utilities.
 *
 * Changelog:
 * - Refactored from functions.php to global.php (Date).
