                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($booking['status'] === 'active'): ?>
                                <form action="/public/admin/dashboard.php?page=rezerwacje" method="POST" style="display:inline;">
                            ...
                            <?php else: ?>
                                <form action="/public/admin/dashboard.php?page=rezerwacje" method="POST" style="display:inline;">
                                    <input type="hidden" name="action" value="reactivateBooking">
                                    <input type="hidden" name="booking_id" value="<?php echo $booking['id']; ?>">
                                    <button type="submit" class="btn btn-success btn-sm" 
                                            onclick="return confirm('Czy na pewno chcesz przywrócić tę rezerwację?');">
                                        Przywróć
                                    </button>
                                </form>
                            <?php endif; ?>
