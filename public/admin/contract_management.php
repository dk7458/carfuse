...
// Fetch contracts
$statusFilter = isset($_POST['status']) ? htmlspecialchars($_POST['status']) : null;
...
<div class="container mt-5">
    <h1 class="text-center">Zarządzanie Umowami</h1>

    <form method="POST" action="/public/admin/dashboard.php?page=umowy" class="standard-form row g-3 mt-4">
        <div class="col-md-6">
