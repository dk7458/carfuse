...
<head>
    ...
    <title>CarFuse - Błąd serwera</title>
    <!-- Tailwind CSS -->
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full bg-white rounded-lg shadow-md p-8 text-center">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-3">Wystąpił błąd</h1>
        
        <p class="text-gray-600 mb-6">
            Przepraszamy, ale napotkaliśmy nieoczekiwany problem podczas przetwarzania Twojego żądania.
            Nasi technicy zostali powiadomieni o błędzie i pracują nad jego rozwiązaniem.
        </p>
